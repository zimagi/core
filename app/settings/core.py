...
GOOGLE_DRIVE_EMAIL = Config.string("ZIMAGI_GOOGLE_DRIVE_EMAIL", None)
GOOGLE_DRIVE_PROJECT_ID = Config.string("ZIMAGI_GOOGLE_DRIVE_PROJECT_ID", None)
GOOGLE_DRIVE_PRIVATE_KEY_ID = Config.string("ZIMAGI_GOOGLE_DRIVE_PRIVATE_KEY_ID", None)
GOOGLE_DRIVE_PRIVATE_KEY = Config.string("ZIMAGI_GOOGLE_DRIVE_PRIVATE_KEY", None)
GOOGLE_DRIVE_CLIENT_EMAIL = Config.string("ZIMAGI_GOOGLE_DRIVE_CLIENT_EMAIL", None)
GOOGLE_DRIVE_CLIENT_ID = Config.string("ZIMAGI_GOOGLE_DRIVE_CLIENT_ID", None)
